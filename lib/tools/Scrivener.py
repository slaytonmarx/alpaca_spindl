...
def load_symbols(filename:str = 'active_symbols'):
    ...
    path = '/alpaca_spindl/metadata/symbol_lists/'+filename if p.isfile('/alpaca_spindl/metadata/symbol_lists/'+filename) else '/alpaca_spindl/metadata/symbol_lists/'+filename
